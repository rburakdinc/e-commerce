...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request): View
    {
        ...
        if ($payment->getStatus() == "success") {
            ...
            //Fatura Oluştur
            $invoice= $this->createInvoiceWithDetails($order);
            return view("frontend.checkout.success",["invoice" => $invoice]);
    ...
    private function createInvoiceWithDetails(Order $order):Invoice
    {
        $invoice = new Invoice([
            "order_id" => $order->order_id,
            "code" => $order->code
